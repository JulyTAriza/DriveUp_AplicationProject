...
import { fetchCars } from "@utils"; // Esta función debe ser actualizada
...
export default async function Home({
  ...
  // ✅ Pasamos los parámetros de búsqueda a la API de tu backend
  // NOTA: Debes adaptar la función fetchCars en @utils para llamar a tu API
