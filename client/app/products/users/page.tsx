...
import SideBar from "@/components/SideBar"; // ✅ Ruta de importación corregida

/**
 * Componente que contiene toda la lógica y la tabla de gestión de usuarios.
 * No es un default export.
 */
const UsersContent = () => {
 ...
 * Este es el **único default export** para el archivo.
 * Renderiza el Sidebar y el UsersContent.
 */
export default function UsersPage() {
  return (
    <div className="flex min-h-screen bg-gray-100">
      <SideBar /> {/* ✅ El Sidebar se renderiza aquí */}
      <main className="flex-1 p-8">
        <UsersContent /> {/* ✅ Y aquí la lógica de tu tabla de usuarios */}
      </main>
    </div>
  );
}
