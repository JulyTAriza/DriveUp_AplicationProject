...
import UserSidebar from "@/components/SideBar"; // ✅ Importamos el sidebar
...
const handleDelete = async (cat: Category) => {
  if (cat.cars_id && cat.cars_id.length > 0) {
    alert(
      "No se puede eliminar esta categoría porque tiene autos asociados. Primero reasigne los autos a otra categoría."
    );
    return;
  }
