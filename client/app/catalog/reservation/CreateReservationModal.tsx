...
export default function CreateReservationModal({
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      // ✅ Armar payload en el mismo orden que espera el backend
      const newRes: NewReservation = {
        user_id: parsedUser.id,
        car_id: selectedCar,
        pickUp,
        rentalStart: dayjs(rentalStart).format("YYYY-MM-DD"),
        rentalEnd: dayjs(rentalEnd).format("YYYY-MM-DD"),
        status,
      };
      ...
      // ✅ aquí ya debería venir el ID asignado por el backend
