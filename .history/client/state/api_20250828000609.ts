...
// ⚠️ NOTA: Este tipo ya no se usará en las funciones create/update de esta API.
// La lógica de FormData se moverá al componente.
...
export const carApi = {
  ...
  // ✅ CORRECCIÓN: La función `create` ahora recibe directamente un objeto FormData.
  // La lógica de adjuntar los datos y archivos se traslada al componente.
  ...
  // ✅ CORRECCIÓN: La función `update` ahora recibe directamente un objeto FormData.
  // Esto simplifica la API y hace que la lógica sea más coherente.
