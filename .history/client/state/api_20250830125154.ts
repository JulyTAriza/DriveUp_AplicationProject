...
  updateStars: async (id: number, stars: number): Promise<Reservation> => {
    const res = await api.patch(`/reservas/${id}/stars?stars=${stars}`);
    return res.data;
  },

  // ❤️ Nueva función para actualizar el estado de favorito (favorite)
