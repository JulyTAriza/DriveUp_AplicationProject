    ...
    <header className="w-full fixed top-0 z-50 bg-white shadow-md">
      ...
      >
        ...
        <div className="flex gap-6 items-center">
          ...
          <Link href="/catalog" className="hover:text-[#013d0b] font-medium">
            Catálogo
          </Link>
          ...
          {isLoggedIn ? (
            <>
              <Link
                href="/perfil"
                className="hover:text-[#013d0b] font-medium"
              >
                Perfil
              </Link>
              <button
            ...
            <>
              ...
              <Link
                href="/register"
                className="border border-[#001402] text-[#001402] rounded-full px-6 py-3"
              >
                Crear cuenta
              </Link>
            </>
