  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // ✅ 1. Siempre cargar los autos primero para que el modal funcione
        const autos = await carApi.getAll();
        setCars(autos);

        // ✅ 2. Cargar las reservas del usuario (si está logueado)
        ...
        if (userId) {
          userReservations = await reservationApi.getByUserId(userId);
        }
