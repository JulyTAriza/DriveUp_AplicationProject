...
import Pagination from "@/components/Pagination"; // ⬅️ nuestro componente
...
export default function CatalogPage() {
  ...
  const pageSize = 9; // autos por página
  ...
  // 🔗 Traer autos desde el backend (sin cambios en api.ts)
  useEffect(() => {
  ...
  // 🚗 Autos de la página actual
  const startIndex = (currentPage - 1) * pageSize;
  const currentCars = cars.slice(startIndex, startIndex + pageSize);
