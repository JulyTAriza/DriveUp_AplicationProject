...
export default function CarDetailsPage({ params }: CarDetailsPageProps) {
  ...
  // ✅ La clave de la solución: si la página está cargando, mostramos un mensaje
  if (isLoading || !car) {
    return <div>Cargando detalles del auto...</div>;
  }

  const handleReservarClick = () => {
    // Esta lógica ahora es segura y se ejecuta después de que el estado de autenticación se ha resuelto
    if (!user) {
      router.push('/login');
    } else {
