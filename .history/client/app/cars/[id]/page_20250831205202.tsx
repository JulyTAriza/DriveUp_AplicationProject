...
export default function CarDetailsPage({ params }: CarDetailsPageProps) {
  ...
  // Si el auto tiene solo 1 imagen -> abajo se muestran defaults
  const thumbnails =
    mainImages.length > 1 ? mainImages : defaultThumbnails;
