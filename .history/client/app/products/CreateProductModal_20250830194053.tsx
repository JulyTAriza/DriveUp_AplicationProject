...
import { Car, NewCar, carApi, Category, categoryApi } from "@/state/api";
...
export default function CreateCarModal({
  ...
  useEffect(() => {
    if (car) {
      setFormData({
        ...
        category_id: car.category?.id || categories[0]?.id || 1,
        images: [],
  ...
  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="bg-white rounded-md shadow-lg max-w-4xl w-full max-h-[90vh] relative flex flex-col">
        <div className="overflow-y-auto p-6 flex-1">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <select
              ...
              onChange={handleChange}
              className="w-full p-2 border rounded mb-3 relative z-50"
            >
              {categories.map((cat) => (
