...
import { categoryApi, Category } from "@/state/api"; // debes tener este en api.ts
import CreateCategoryModal from "./CreateCategoryModal"; // modal similar a CreateCarModal
