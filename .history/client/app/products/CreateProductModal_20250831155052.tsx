...
export default function CreateCarModal({
  ...
  // useEffect 1: Se encarga de cargar las categorías
  useEffect(() => {
    if (!isOpen) {
  ...
  // useEffect 2: Se encarga de inicializar el formulario con los datos del auto cuando las categorías ya están cargadas.
  useEffect(() => {
