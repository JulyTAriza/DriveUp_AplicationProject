    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(HttpMethod.PUT, "/usuarios/me").hasAuthority("USER")  // editar perfil propio
                .requestMatchers(HttpMethod.PUT, "/usuarios/**").hasAuthority("ADMIN") // editar cualquiera
