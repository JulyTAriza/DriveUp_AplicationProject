...
public class CarReservationController {
    ...
    // ✅ NUEVO: ENDPOINT PARA OBTENER LAS RESERVAS DE UN USUARIO ESPECÍFICO
    ...
    // ---------------------------------------------------
    // 🔹 NUEVOS ENDPOINTS PARA FAVORITO Y PUNTUACIÓN
    // ---------------------------------------------------

    // ⭐ Actualizar puntuación (stars)
    @PatchMapping("/{id}/stars")
    public ResponseEntity<CarReservationDTO> updateStars(
            @PathVariable Long id,
            @RequestParam int stars) throws ResourceNotFoundException {
        return ResponseEntity.ok(iCarReservationService.updateStars(id, stars));
    }

    // ❤️ Actualizar favorito (favorite)
    @PatchMapping("/{id}/favorite")
    public ResponseEntity<CarReservationDTO> updateFavorite(
            @PathVariable Long id,
            @RequestParam boolean favorite) throws ResourceNotFoundException {
        return ResponseEntity.ok(iCarReservationService.updateFavorite(id, favorite));
    }
}
